...
export default function Hero() {
  return (
    <section className="relative rounded-3xl overflow-hidden mb-16 border border-gray-700/50 bg-gradient-to-br from-gray-900 to-gray-950 shadow-2xl shadow-black/40">
      {/* Fondo con efecto de partículas sutiles y gradiente dinámico */}
      <div className="absolute inset-0 overflow-hidden">
        <div
          className="absolute inset-0 bg-cover bg-center opacity-30"
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1506765515384-028b60a970df?auto=format&fit=crop&w=1400&q=80')",
          }}
        />
        ...
        {/* Gradiente dinámico similar a Vercel */}
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-32 text-center text-white z-10">
        {/* Badge de novedad al estilo Vercel */}
        <motion.div
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/30 text-blue-300 text-sm font-medium mb-8"
        >
          <Sparkles size={14} />
        ...
        <motion.h1
          ...
          className="text-5xl md:text-7xl font-bold mb-6 leading-tight tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-300"
        >
          Encuentra las{" "}
        ...
        >
          ...
          <span className="font-medium text-white bg-gradient-to-r from-pink-500/20 to-purple-500/20 px-1.5 py-0.5 rounded">marketing digital</span> y{" "}
          <span className="font-medium text-white bg-gradient-to-r from-blue-500/20 to-cyan-500/20 px-1.5 py-0.5 rounded">herramientas de IA</span> en un solo lugar.
        </motion.p>

        {/* Botones con estilo Vercel */}
        <motion.div
      ...
      {/* Efecto de brillo sutil al estilo Vercel */}
